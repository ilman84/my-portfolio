...
const environmentConfig = {
  ...
  emailService: {
    ...
    config: {
      ...
      resend: {
        apiKey:
          process.env.RESEND_API_KEY || 're_SEWQbSmW_3NsEvztBSwcQK925w9N33jWV',
        fromEmail: 'Portfolio Contact <onboarding@resend.dev>',
        toEmail: process.env.YOUR_EMAIL || 'ilmanbaihaqi@gmail.com',
      },
      ...
      emailjs: {
        serviceId:
          process.env.EMAILJS_SERVICE_ID || 'your_emailjs_service_id_here',
        templateId:
          process.env.EMAILJS_TEMPLATE_ID || 'your_emailjs_template_id_here',
        publicKey:
          process.env.EMAILJS_PUBLIC_KEY || 'your_emailjs_public_key_here',
      },
    },
  },
  ...
  site: {
    url:
      ...
      'https://myportofolio-8ik66hvvf-ilmans-projects-c0d3dacb.vercel.app',
    name: 'My Portfolio',
